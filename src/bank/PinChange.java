...
public class PinChange extends JFrame implements ActionListener {
	...
	public PinChange() {
		...
		l2=new JLabel("Security Question Favourite Color: ");
	...
	public void actionPerformed(ActionEvent e) {
		try {
			...
			String q ="select * from customerdata where pass='"+t2.getText() +"'";
			ResultSet rs= c.stm.executeQuery(q);
			
			String q2 = "select * from customerdata where hobbies='"+t1.getText()+"'";
			ResultSet r = c.st.executeQuery(q2);
			if(rs.next() && r.next()) {
			
			if(e.getSource()== b1) {
				String q3 ="update customerdata set pass ='"+t3.getText()+"'where pass = '"+t2.getText()+"'";
